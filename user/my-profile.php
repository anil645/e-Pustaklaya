...
if (!isLoggedIn()) 
	...
	{    
		...
		$sql="update accounts set FullName=:fname, MobileNumber=:mobileno where id=:sid and user_type = 'user' ";
...
$sql="SELECT id,FullName,email,MobileNumber,RegDate,UpdationDate,Status from  accounts  where id=:sid  ";
$query = $dbh -> prepare($sql);
$query-> bindParam(':sid', $sid, PDO::PARAM_STR);
$query->execute();
